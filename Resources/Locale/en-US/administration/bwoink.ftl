...
bwoink-system-starmute-message-no-other-users = *System: Nobody is available to receive your message. Try contacting game admins on the Dead Space Discord.

bwoink-system-messages-being-relayed-to-discord =
    Your message is visible to online game administrators.
...
bwoink-system-introductory-message =
    ...
    Any bugs and other related issues should be reported through the Dead Space Discord.
...
admin-ahelp-admin-only-tooltip = If checked, then the message won't be visible for the player,
    but will be visible for other admins.
