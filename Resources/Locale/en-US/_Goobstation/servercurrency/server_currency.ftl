...
server-currency-name-singular = Space Credit
server-currency-name-plural = Space Credits
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Space Credits
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Space Credits
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Space Credits
