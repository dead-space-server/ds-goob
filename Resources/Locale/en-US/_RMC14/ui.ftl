...
rmc-ui-link-discord-account = Account Linking Disabled
rmc-ui-link-discord-account-text = Discord account linking is disabled on this server.
...
rmc-ui-shoutout-info = Each name is randomly chosen between all available entries.
