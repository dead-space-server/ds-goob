...
server-currency-name-singular = космокоин
server-currency-name-plural = космокоины
...
gs-balanceui-shop-buy-token-antag = Купить токен антага - { $price } космокоинов
gs-balanceui-shop-buy-token-admin-abuse = Купить токен на злоупотребление админом - { $price } космокоинов
gs-balanceui-shop-buy-token-hat = Купить токен на шляпу - { $price } космокоинов
