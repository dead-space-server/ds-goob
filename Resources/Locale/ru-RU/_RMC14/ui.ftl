...
rmc-ui-link-discord-account = Привязка аккаунта отключена
rmc-ui-link-discord-account-text =
    Привязка Discord-аккаунта отключена на этом сервере.
...
rmc-ui-patron-perks = Дополнительные настройки профиля
rmc-ui-lobby-message = Сообщение в лобби
rmc-ui-lobby-message-description =
    Отображается игрокам перед началом раунда.
    Одно сообщение выбирается случайным образом из всех доступных записей.
...
rmc-ui-shoutout-info =
    Каждое имя выбирается случайным образом из всех доступных записей.
