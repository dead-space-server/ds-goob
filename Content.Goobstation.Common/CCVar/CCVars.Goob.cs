...
public sealed partial class GoobCVars
{
    ...
    public static readonly CVarDef<int> PatronAskSupport =
        CVarDef.Create("patron.ask_support", -1, CVar.REPLICATED | CVar.SERVER);
    ...
    /// <summary>
    ///     Legacy priority queue switch. Disabled for Dead Space Goob.
    /// </summary>
    public static readonly CVarDef<bool> PatreonSkip =
        CVarDef.Create("queue.patreon_skip", false, CVar.SERVERONLY);
