...
SSH_HOST = os.environ.get("CHANGELOG_RSS_HOST", "")
SSH_USER = os.environ.get("CHANGELOG_RSS_USER", "changelog-rss")
SSH_PORT = int(os.environ.get("CHANGELOG_RSS_PORT", "22"))
RSS_FILE = os.environ.get("CHANGELOG_RSS_FILE", "upload/changelog.xml")
XSL_FILE = os.environ.get("CHANGELOG_RSS_XSL_FILE", "stylesheet.xsl")
HOST_KEYS = [key for key in os.environ.get("CHANGELOG_RSS_HOST_KEYS", "").splitlines() if key]

# RSS feed parameters, change these
FEED_TITLE       = "Dead Space Goob Changelog"
FEED_LINK        = "https://deadspace14.net/"
FEED_DESCRIPTION = "Changelog for Dead Space Goob, a Space Station 14 server using the GoobStation build."
FEED_LANGUAGE    = "en-US"
FEED_GUID_PREFIX = "ss14-changelog-deadspace-goob-"
FEED_URL         = os.environ.get("CHANGELOG_RSS_URL", "https://deadspace14.net/changelog.xml")
...
def main():
    if not CHANGELOG_RSS_KEY:
        ...
        return
    if not SSH_HOST or not HOST_KEYS:
        print("::notice ::CHANGELOG_RSS_HOST or CHANGELOG_RSS_HOST_KEYS not set, skipping RSS changelogs")
        return
