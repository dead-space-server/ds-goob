...
#
ROBUST_CDN_URL = os.environ.get("ROBUST_CDN_URL", "https://cdn.deadspace14.net/")
FORK_ID = os.environ.get("FORK_ID", "dsgoob")
...
def get_engine_version() -> str:
    version_props = os.path.join("RobustToolbox", "MSBuild", "Robust.Engine.Version.props")
    if os.path.exists(version_props):
        root = ET.parse(version_props).getroot()
        version = root.findtext(".//RobustEngineVersion")
        if version:
