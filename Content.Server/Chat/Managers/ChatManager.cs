...
// Account linking is disabled for Dead Space Goob.
...
internal sealed partial class ChatManager : IChatManager
{
    ...
    private void SendOOC(ICommonSession player, string message)
    {
        ...
        // Account-linked OOC decoration is disabled for Dead Space Goob.
        ...
        */
        ...
        // Dead Space Goob: donation perks are disabled, so sponsor OOC colors are ignored server-side.
